...
def run_training(
    ...
    """Fit the BPR model, persist artifacts, and log to MLflow."""
    
    # Trỏ MLflow về server localhost đang chạy
    mlflow.set_tracking_uri("http://localhost:5000")
    mlflow.set_experiment("Movie_Recommender_BPR")

    # Bắt đầu theo dõi quá trình huấn luyện
    with mlflow.start_run(run_name="bpr_training_run"):
        # 1. Ghi nhận Hyperparameters
        mlflow.log_params({
        ...
        # 2. Ghi nhận Metrics (Kết quả đánh giá)
        mlflow.log_metrics({
        ...
        # 3. Đóng gói Model và TỰ ĐỘNG ĐĂNG KÝ lên Registry
